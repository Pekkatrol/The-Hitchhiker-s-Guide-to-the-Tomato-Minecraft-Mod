...
public class CompressorScreen extends AbstractContainerScreen<CompressorMenu> {
    ...
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HG2Tomato.MOD_ID, "textures/gui/compressor/compressor_gui.png");
    ...
    private static final ResourceLocation COMBUSTION_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HG2Tomato.MOD_ID, "textures/gui/compression.png");
