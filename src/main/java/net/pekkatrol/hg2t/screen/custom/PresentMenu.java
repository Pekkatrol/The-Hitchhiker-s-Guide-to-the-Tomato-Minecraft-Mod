...
public class PresentMenu extends AbstractContainerMenu {
    ...
    public final PresentBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public PresentMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public PresentMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.PRESENT_MENU.get(), pContainerId);
        this.blockEntity = (PresentBlockEntity) entity;
