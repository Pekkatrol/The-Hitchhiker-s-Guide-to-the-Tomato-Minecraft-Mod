...
public class CombustionGeneratorScreen extends AbstractContainerScreen<CombustionGeneratorMenu> {
    ...
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HG2Tomato.MOD_ID, "textures/gui/combustion_generator/combustion_generator_gui.png");
    ...
    private static final ResourceLocation COMBUSTION_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HG2Tomato.MOD_ID, "textures/gui/combustion_gui.png");
