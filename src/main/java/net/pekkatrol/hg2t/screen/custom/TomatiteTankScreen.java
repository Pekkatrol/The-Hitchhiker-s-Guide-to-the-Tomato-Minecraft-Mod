...
public class TomatiteTankScreen extends AbstractContainerScreen<TomatiteTankMenu> {

    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(HG2Tomato.MOD_ID, "textures/gui/tomatite_tank/tomatite_tank_gui.png");
    private EnergyInfoArea energyInfoArea;

    public TomatiteTankScreen(TomatiteTankMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
