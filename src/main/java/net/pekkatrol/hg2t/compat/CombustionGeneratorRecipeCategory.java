...
public class CombustionGeneratorRecipeCategory implements IRecipeCategory {
    ...
    public void setRecipe(IRecipeLayoutBuilder builder, Object recipe, IFocusGroup focuses) {
        builder.addSlot(RecipeIngredientRole.INPUT, 26, 34).addIngredients(((CombustionGeneratorRecipe)recipe).getIngredients().get(0));

        builder.addSlot(RecipeIngredientRole.OUTPUT, 80, 34).addItemStack(((CombustionGeneratorRecipe)recipe).getResultItem(null));
    }
}
